...
export function Home(props) {
  ...
  if (loading)
    return (
      <img
        style={loadGif}
        src="https://avatarfiles.alphacoders.com/890/89063.gif"
        alt="jumpingtoto"
      />
    );
  ...
  return (
    <>
      <div style={logoStyle} className="flex flex-wrap">
        <img
          style={imageStyle}
          src="https://www.pngkey.com/png/full/133-1338872_-hayao-miyazaki-princess-mononoke-ponyo-spirited-away.png"
          alt="logo"
        />
      </div>
