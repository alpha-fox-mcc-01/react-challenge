      ...
      <div id="film-card" className="max-w-xs rounded shadow-lg my-2" style={styles}>
        <div className="img-container">        
          ...
          <div id="film-description" className="px-6 py-4">
            ...
            <button onClick={() => RouteChange(props.film.id)} className="bg-transparent hover:bg-yellow-500 text-grey-400 font-semibold hover:text-white py-2 px-4 border border-yellow-500 hover:border-transparent rounded">
              View Details
            </button>
          </div>
        </div>
